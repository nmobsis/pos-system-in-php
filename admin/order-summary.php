        ...
        <div class="card-body">
                    ...
                    <tbody>
                      <tr>
                        <td style="text-align: center;" colspan="2">
                          ...
                          <p style="font-size: 16px; line-height: 24px; margin: 2px; padding: 0;">#555, 1st street, 3rd cross, Country</p>
                      ...
                      <tr>
                        ...
                        <td align="end">
                          ...
                          <p style="font-size: 14px; line-height: 20px; margin: 0px; padding: 0;">Address: 1st main road, country</p>
                        </td>
                      </tr>
                    </tbody>
                  </table>
          ...
          <?php if(isset($_SESSION['productItems'])) : ?>
            <div class="mt-4 text-end">
              ...
              <button class="btn btn-info px-4 mz-1" onclick="printMyBillingArea()" >Print</button>
